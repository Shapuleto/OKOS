...
<body <?php body_class(''); ?>>
	<?php /* "require header_top.php". original theme options */ ?>
	<?php
		$hideslide = get_theme_mod('hide_slider', '1');
	?>
	<!-- Start	- div.header section -->
			...
			<section id="wrapfirst">
				<div class="container">
					<div class="welcomewrap">
						...
						<h2><?php the_title(); ?></h2> 
								<?php the_content(); ?> 
						<a class="donatebtn" href="<?php the_permalink(); ?>"><?php _e('Donate Now!','skt-charity'); ?></a>
						<div class="clear"></div>
								<?php
							endwhile;
						}else{
						...
						<p><?php echo wp_kses_post('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer sodales suscipit tellus, ut tristique neque suscipit a. Mauris tristique lacus quis leo imperdiet sed pulvinar dui fermentum. Aenean sit amet diam non tortor sagittis varius. Aenean at lorem nulla, sit amet interdum nibh. Mauris sit amet dictum turpis. Sed ut sapien magna. Lorem ipsum dolor sit amet, consectetur adipiscing elit Aliquam gravida odio nec dui ornare tempus elementum lectus rhoncus. <br /> <br />
							...
							Suspendisse lobortis pellentesque orci, in sodales nisi pretium sit amet. Aenean vulputate, odio non euismod eleifend, magna nisl elementum lorem, ac venenatis nunc erat et metus. Nulla volutpat urnaeu tellus odio hendrerit nibh. ','skt-charity'); ?>
						</p>
						<a class="donatebtn" href="<?php echo esc_url('#');?>"><?php _e('Donate Now!','skt-charity'); ?></a>
						<?php
						}
						?>
					</div><!-- welcomewrap-->
	...
	if($hideslide == ''){ ?>
		...
		<?php
		if(!empty($id_arr)){ ?>
	<section id="home_slider" class="is-front-page">
		<div class="slider-wrapper theme-default">
			<div id="slider" class="nivoSlider">
			<?php 
			$i = 1;
	...
	<section id="home_slider" class="">
		<div class="slider-wrapper theme-default">
			<div id="slider" class="nivoSlider">
				<img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>-child/images/slides/slider1.jpeg" alt="" title="#slidecaption1" />
				<img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>-child/images/slides/slider2.jpeg" alt="" title="#slidecaption2" />
				<img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>-child/images/slides/slider3.jpeg" alt="" title="#slidecaption3" />
				<img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>-child/images/slides/slider4.jpeg" alt="" title="#slidecaption3" />
			</div>
			<div id="slidecaption1" class="nivo-html-caption">
				<div class="slide_info">
					<h2><?php esc_html_e('We Need Your Support to Accommodate, Feed and Educate.','skt-charity'); ?></h2>
